 ...
 */
public class AccessEgressRouteCacheImpl implements AccessEgressRouteCache {

	public static final double FREESPEED_TRAVELTIME_FACTOR = 1.25;
	private final static Logger LOGGER = LogManager.getLogger(AccessEgressRouteCacheImpl.class);
	...
	@Inject
	public AccessEgressRouteCacheImpl(ZonesCollection allZones, SingleModeNetworksCache singleModeNetworksCache, Config config, Scenario scenario) {
	...
	public static void main(String[] args) {
		...
		AccessEgressRouteCacheImpl cache = new AccessEgressRouteCacheImpl((ZonesCollection) scenario.getScenarioElement(ZonesModule.SBB_ZONES), singleModeNetworksCache, config, scenario);
	...
	@Override
	public AccessEgressRouteCache.RouteCharacteristics getCachedRouteCharacteristics(String mode, Facility stopFacility, Facility actFacility, RoutingModule module, Person person) {
		...
		return new AccessEgressRouteCache.RouteCharacteristics(value[0], accessTime, value[2], value[1] * FREESPEED_TRAVELTIME_FACTOR);
	}
