...
public class ConvergenceConfigGroup extends ReflectiveConfigGroup {
	...
	public Map<String, String> getComments() {
		...
		map.put(ITERATION_WINDOW_SIZE_PARAM,
	...
	public static class ConvergenceCriterionFunctionWeight extends ReflectiveConfigGroup {
		...
		public Map<String, String> getComments() {
			...
			map.put(FUNCTION_WEIGHT_PARAM,
					"Weight for this term in the convergence criterion function. Defaults to 1.0. The criterion function is a linear sum of the (weighted) test results. Warning: there is no check for duplicates, each matching parameterSet becomes an added term to the function (matching done by string equality or 'all').");
			return map;
		}
