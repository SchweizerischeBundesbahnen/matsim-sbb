...
public class PotentialAnalysis {
	...
	private void run(String transitScheduleFilename, String networkFilename, String facilitiesFilename, String shapefile) {
		...
		new TransitScheduleWriter(scenario.getTransitSchedule())
				.writeFile("\\\\Filer16L\\P-V160L\\SIMBA.A11244\\40_Projekte\\20190515_MOBi_Anwendung_NMD\\20_Arbeiten\\10_PotentialAnalyse\\01_Daten\\stations\\transitSchedule.xml.gz");
