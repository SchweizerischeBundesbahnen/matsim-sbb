...
import ch.sbb.matsim.analysis.matrices.PTFrequencyMatrix.ODConnection;
 ...
 * @author mrieser
 */
public class PTFrequencyMatrixTest {
    ...
    public void testCalcAvgAdaptionTime() {
        ...
        adaptionTime = PTFrequencyMatrix.RowWorker.calcAverageAdaptionTime(connections, Time.parseTime("08:00:00"), Time.parseTime("09:00:00"));
